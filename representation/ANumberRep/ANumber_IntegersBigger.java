...
public class ANumber_IntegersBigger implements ANumber, Test, Candidate {

    private int[] n;
    private final int RESOLUTION = 100;

    
    public ANumber_IntegersBigger() {
        super();
    }
    ...
    public void setVals(int randCount, Random r) {
        ...
        for (int i=0; i<randCount; i++)
            n[i] = (int) Math.round(r.nextGaussian()*10 + 100); // for bigger. 
    }
    ...
    public PopulationMember getMutation (Random r, double mRate, int mBias, double mSize) {
        ...
        ANumber_IntegersBigger ani = new ANumber_IntegersBigger();
