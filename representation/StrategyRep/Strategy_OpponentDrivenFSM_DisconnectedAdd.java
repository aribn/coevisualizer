...
public class Strategy_OpponentDrivenFSM_DisconnectedAdd implements OpponentDriven_FSM, Strategy, Test, Candidate {
    ...
    public Strategy_OpponentDrivenFSM_DisconnectedAdd() {
        super();
    }
    ...
    public PopulationMember getMutation (Random r, double mRate, int mBias, double mSize) {
		...
		Strategy_OpponentDrivenFSM_DisconnectedAdd so = new Strategy_OpponentDrivenFSM_DisconnectedAdd();
