...
public abstract class Game_ng1d extends Game_ngNd implements Renderable {

    public int getNumberOfDimensions() { return 1; }
	...
	public Dimension getDimension() {			 	return new Dimension(300,50);		}
    ...
    public Graphics renderGeneration(Candidate[] cands, Test[] tests, Graphics bg, Random viewerSpecificRandom) {
        ...
        bg.drawLine(width/2, height/2-5, width/2, height/2+5);
        ...
        for (int i=0; i<cands.length; i++) {
            ...
            bg.fillRect(width/2 + (int) (scalar * coords[0]), height/2-4, 2, 4);
        }
        ...
        for (int i=0; i<tests.length; i++) {
            ...
            bg.fillRect(width/2 + (int) (scalar * coords[0]), height/2, 2, 4);
        }
