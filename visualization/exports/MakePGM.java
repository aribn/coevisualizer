package coeviz.visualization.exports;
...
public class MakePGM {
    ...
    public MakePGM (String path_to_run_dir) {
        try {
            ...
            String m_Str		= properties.getProperty(CoevPropertiesEditor.MEMORY_WINDOW_SIZE);
            int genCount		= Integer.parseInt(properties.getProperty(CoevPropertiesEditor.MAX_GENERATION_COUNT));
            int cPopSize		= Integer.parseInt(properties.getProperty(CoevPropertiesEditor.CANDIDATE_POPULATION_SIZE));
            int tPopSize 		= Integer.parseInt(properties.getProperty(CoevPropertiesEditor.TEST_POPULATION_SIZE));
    ...
    public static void main (String args[]) {
        if (args.length != 1)
            System.out.println("Usage: java MakePGM <path_to_a_run_dir>");
